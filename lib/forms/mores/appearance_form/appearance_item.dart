...
class AppearanceButton extends StatefulWidget {
  final Function() onClicked;
  final String name;
  final Icon img;
  final int index;
  const AppearanceButton(this.onClicked, this.name, this.img, this.index,
      {Key? key})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return AppearanceButtonState();
  }
}

class AppearanceButtonState extends State<AppearanceButton>
